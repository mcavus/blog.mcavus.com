...
My website ([mcavus.com](https://mcavus.com)) needed a renovation. Even though it looks simple, it took a while to get the design just right.
...
For the blog, I built a brand-new Mac app called [Overprint](https://overprint.mcavus.com). More on that in the next blog post.
